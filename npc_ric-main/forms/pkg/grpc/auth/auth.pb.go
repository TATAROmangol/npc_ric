...
const file_auth_proto_rawDesc = "" +
	...
	"\x06Verify\x123\n" +
	"\x06Verify\x12\x13.auth.VerifyRequest\x1a\x14.auth.VerifyResponseB\"Z github.com/npc_ric/pkg/grpc/authb\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth.Verify.Verify:input_type -> auth.VerifyRequest
	1, // 1: auth.Verify.Verify:output_type -> auth.VerifyResponse
